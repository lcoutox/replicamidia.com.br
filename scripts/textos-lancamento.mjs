...
export const TEXTOS = {
  ...
  "leilao-imoveis-publicos-setembro": {
    ...
    corpo: [
      ...
      h("O que a Réplica está checando"),
      p("A lei que autorizou a venda de cada imóvel, o laudo de avaliação e a destinação da receita no orçamento. Assim que o edital for confirmado, atualizamos com os detalhes."),
    ],
  },
  ...
  "vacinacao-antirrabica-prorrogada": {
    ...
    corpo: [
      ...
      h("O contexto"),
      p("Prorrogação costuma significar que a meta de cobertura não foi atingida no prazo original. A Réplica pediu a [CONFIRMAR: órgão responsável] os números de animais vacinados e a meta da campanha."),
    ],
  },
  ...
  "pedagio-br-262-mais-caro": {
    ...
    corpo: [
      ...
      p("Reajuste de pedágio costuma ser previsto em contrato e vinculado a um índice e a um cronograma de obras. A Réplica está checando com a [CONFIRMAR: ANTT e concessionária] qual índice embasa o aumento e o que foi entregue de obra no trecho desde o último reajuste."),
    ],
  },
  ...
  "novo-hospital-prometido-e-entregue": {
    ...
    corpo: [
      ...
      p("A Réplica pediu à administração o cronograma da obra, o contrato de compra dos equipamentos e a definição do modelo de gestão. Enquanto os documentos não chegam, este texto reúne o que já é público e o que segue em aberto."),
  ...
  "mortes-na-br-262": {
    status: "apurar",
    corpo: [
      p("Um ciclista morreu ao ser atingido por um carro na BR-262, em Nova Serrana. [CONFIRMAR: data, trecho e circunstância básica, conforme boletim de ocorrência]. A morte reacende uma cobrança antiga de moradores sobre o trecho urbano da rodovia. A Réplica foi levantar o histórico de acidentes e o que já foi pedido — e prometido — para o local."),
      h("O que se sabe"),
      ul(
  ...
  "seguranca-no-trabalho-morte-no-varejo": {
    status: "apurar",
    corpo: [
      p("Um trabalhador morreu após cair de uma escada enquanto repunha mercadorias em um supermercado de Nova Serrana. [CONFIRMAR: data e local; avaliar se o estabelecimento será nomeado]. A Réplica trata o caso não como crônica policial, mas como porta de entrada para um assunto que a cidade, com sua indústria e seu comércio, não pode ignorar: a prevenção de acidentes de trabalho."),
      h("O que se sabe"),
      ul(
